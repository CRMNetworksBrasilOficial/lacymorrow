/**
 * @license AngularJS v1.2.15-build.local+sha.21243d6
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.15-build.local+sha.21243d6/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.15-build.local+sha.21243d6',    // all of these placeholder strings will be replaced by grunt's
