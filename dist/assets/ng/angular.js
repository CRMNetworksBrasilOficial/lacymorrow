/**
 * @license AngularJS v1.2.15-build.local+sha.ad309b1
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.15-build.local+sha.ad309b1/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.15-build.local+sha.ad309b1',    // all of these placeholder strings will be replaced by grunt's
